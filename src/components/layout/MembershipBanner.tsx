    ...
    <>
      <Card className="p-8 bg-gradient-to-r from-amber-50 to-orange-200 border-amber-200 dark:from-amber-950 dark:to-orange-800 dark:border-amber-800">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Button
              className="flex items-center space-x-2 bg-amber-500 hover:bg-amber-500/85 dark:text-background cursor-pointer"
              onClick={() => {
                setOpenModal(true);
              }}
            >
      ...
      <MembershipModal openModal={openModal} setOpenModal={setOpenModal} />
    </>
  );
}
